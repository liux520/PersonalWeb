...
const config: Config = {
  ...
  theme: {
    extend: {
      // ============================================
      // DEEP INDIGO RESEARCH PALETTE
      // Sophisticated indigo/violet system conveying
      // depth, intelligence, and academic authority
      // ============================================
      colors: {
        primary: {
          50: '#eef2ff',
      ...
      // ============================================
      // TYPOGRAPHY SYSTEM
      // Font family variables defined in layout.tsx:
      ...
      keyframes: {
        ...
        glow: {
          '0%': {
            boxShadow: '0 0 20px rgba(99, 102, 241, 0.15), 0 0 40px rgba(99, 102, 241, 0.1)',
          },
          '100%': {
            boxShadow: '0 0 30px rgba(99, 102, 241, 0.3), 0 0 60px rgba(168, 85, 247, 0.2)',
          },
        },
        shimmer: {
